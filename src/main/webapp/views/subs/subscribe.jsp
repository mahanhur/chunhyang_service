      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center">
            ...
            <!-- Buttons -->
            <a class="btn btn-outline-white border-2 px-md-8 m-2 m-md-4" href="shop.html">6개월 베이직</a>
            <a class="btn btn-outline-white border-2 px-md-8 m-2 m-md-4" href="shop.html">6개월 프리미엄</a>
            <a class="btn btn-outline-white border-2 px-md-8 m-2 m-md-4" href="shop.html">6개월 시그니쳐</a>
            <a class="btn btn-outline-white border-2 px-md-8 m-2 m-md-4" href="shop.html">12개월 베이직</a>
            <a class="btn btn-outline-white border-2 px-md-8 m-2 m-md-4" href="shop.html">12개월 프리미엄</a>
            <a class="btn btn-outline-white border-2 px-md-8 m-2 m-md-4" href="shop.html">12개월 시그니쳐</a>
            <a class="btn btn-outline-white border-2 px-md-8 m-2 m-md-4" href="shop.html">3회권</a>
            <a class="btn btn-outline-white border-2 px-md-8 m-2 m-md-4" href="shop.html">7회권</a>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="brand lift mb-7 text-center" style="display: flex;">
        <span><img src="/uimg/icon_cal.png" width="60px" style="margin-left: 150px"></span>
        <div style="margin-left: 150px; display:flex; flex-direction: column">
    ...
    <div class="row">
      <div class="brand lift mb-7 text-center" style="display: flex;">
        <span><img src="/uimg/icon_flower.png" width="60px" style="margin-left: 150px"></span>
        <div style="margin-left: 150px; display:flex; flex-direction: column">
    ...
    <div class="row">
      <div class="brand lift mb-7 text-center" style="display: flex;">
        <span><img src="/uimg/icon_box.png" width="60px" style="margin-left: 150px"></span>
        <div style="margin-left: 150px; display:flex; flex-direction: column">
