  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-12 col-md-4">
        ...
        <!-- Card -->
        <a class="card mb-7 bg-transparent text-body" href="/">
      ...
      <div class="col-12">
        ...
        <div class="flickity-buttons-lg flickity-light px-lg-12" data-flickity='{"prevNextButtons": true}'>
          <div class="col-12 col-md-4 col-lg-3 pt-1 px-4">
            ...
            <!-- Card -->
            <a class="card card-sm bg-transparent text-white" href="/about">
          ...
          <div class="col-12 col-md-4 col-lg-3 pt-1 px-4">
            ...
            <!-- Card -->
            <a class="card card-sm bg-transparent text-white" href="/contact-us">
          ...
          <div class="col-12 col-md-4 col-lg-3 pt-1 px-4">
            ...
            <!-- Card -->
            <a class="card card-sm bg-transparent text-white" href="/store-locator">
          ...
          <div class="col-12 col-md-4 col-lg-3 pt-1 px-4">
            ...
            <!-- Card -->
            <a class="card card-sm bg-transparent text-white" href="/faq">
